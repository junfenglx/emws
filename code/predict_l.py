        ...
        if sent:
            ...
            for pos, char in enumerate(old_sentence): # char is still the char from original sentence, for correct eval
                if pos== 0:
                    ...
                    score_list, _, _, _, _ = model.predict_single_position(sentence, pos, prev2_label, prev_label, states=labels)
...
if __name__ == '__main__':
    ...
    seged, all_labels = segment_corpus(model, test_corpus, threshold)
