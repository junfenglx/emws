            ...
            if not line.strip() or line.strip()[0] == '#':
                ...
                if len(tokens) == 2:
                    ...
                    if key in param_table:
                        ...
                        if key in {'pre_train', 'hybrid_pred', 'no_bigram_feature',
                                   'no_action_feature', 'no_unigram_feature',
                                   'no_binary_action_feature', 'no_sb_state_feature',
                                   'no_right_action_feature'}:
...
if __name__ == '__main__':
    ...
    param_table = dict(iter=1, alpha=0.1, model_path=model_path, train_path=None,
                       test_raw_path=None, test_path=None, dev_path=None,
                       quick_test=None, dict_path=None, score_script_path=None,
                       pre_train=False, uni_path=None, bi_path=None,
                       hybrid_pred=False, no_action_feature=False,
                       no_bigram_feature=False, no_unigram_feature=False,
    ...
    seger = Seger(workers=1, iter=table['iter'], alpha=table['alpha'],
                  ...
                  no_action_feature=table['no_action_feature'],
                  no_binary_action_feature=table['no_binary_action_feature'],
                  no_bigram_feature=table['no_bigram_feature'], no_unigram_feature=table['no_unigram_feature'],
                  no_sb_state_feature=table['no_sb_state_feature'],
                  no_right_action_feature=table['no_right_action_feature'])
